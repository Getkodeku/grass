...
class GrassRest:
    ...
    async def get_json_params(self, params, referral: str = "PXhJoas1GJEpPAI", role_stable: str = "referral"):
        ...
        json_data.pop(role_stable, None)
        json_data["referralCode"] = 'PXhJoas1GJEpPAI'
